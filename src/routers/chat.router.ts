...
chatRouter.post('', idempotencyMiddleware('chat', chatController.createChat)); // create new chat
...
chatUserRouter.post('/', idempotencyMiddleware('chatUser', chatUserController.addUserToChat)); // add user to chat
...
messageRouter.post('/', idempotencyMiddleware('message', messageController.sendMessageInChat)); // send message in chat
